...
const experience = [
  {
    ...
    description: [
      ...
      "Diagnose and resolve complex customer issues by investigating application behavior, identifying root causes, and guiding users through effective solutions",
      "Analyze customer-reported issues and product feedback, collaborating with product and technical teams to communicate recurring problems, feature requests, and opportunities for improvement",
      "Document customer interactions, troubleshooting steps, and product feedback to maintain accurate knowledge and support continuous improvement of internal resources",
      "Leverage technical knowledge and problem-solving skills to connect customer needs with product functionality and technical teams in a fast-paced software environment",
    ],
  },
  {
    years: "May 2024 — Feb 2026",
