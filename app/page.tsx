      ...
      <main className="mx-auto max-w-6xl px-6 md:px-10  min-h-[55vh]">
        <div>
          ...
          <section >
            ...
            >
             Full-stack developer with experience building and maintaining web applications across front-end, back-end, API, and database systems. Strong problem-solving and communication skills, with a focus on developing practical, reliable, and maintainable solutions while effectively understanding and addressing user needs.
             </p>
