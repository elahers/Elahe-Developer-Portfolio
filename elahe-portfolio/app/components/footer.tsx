    ...
    <footer className="mt-24 pt-6">
      ...
      <div className="flex items-end justify-between gap-6 flex-wrap">
        ...
        <div className="min-w-0">
          ...
          <form
            action="https://formspree.io/f/xjgpjvzw"
            method="POST"
            className="flex items-center gap-2 text-xs max-w-md"
          >
            <input
              type="text"
              name="name"
              placeholder="Name"
              required
              className="bg-transparent border border-white/10 px-2 py-1 text-white outline-none w-24"
            />
            ...
            <input
              ...
              placeholder="Message"
              required
              className="bg-transparent border border-white/10 px-2 py-1 text-white outline-none w-40"
            />

            <button
              type="submit"
              className="px-2 py-1 border border-white/20 hover:bg-white hover:text-black transition"
            >
              Send
            </button>
          </form>
